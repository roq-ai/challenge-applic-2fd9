  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Challenge Application - Ignite your competitive spirit. Create challenges, engage with others, and rise to the occasion in a dynamic, user-centric platform."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1502101872923-d48509bff386?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxjaGFsbGVuZ2V8ZW58MHx8fHwxNjk3MDYwMTE2fDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@tateisimikito?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Jukan Tateisi`}</Link>{' '}
              on{' '}
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Challenge Application - Ignite your competitive spirit. Create challenges, engage with others, and rise to the occasion in a dynamic, user-centric platform.`}
            </Text>
            <Box
            ...
            >
              <Stack direction={{ md: 'row', base: 'column' }} spacing="1.5rem">
                <Card userTypeName="Challenge Creator" type="challenge-creator" abilities={appConfig.ownerAbilities} />
              </Stack>
            </Box>
          </Box>
          <Box pt={4}>
