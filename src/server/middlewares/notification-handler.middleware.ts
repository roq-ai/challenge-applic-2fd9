...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'ChallengeCreated.create': {
    roles: ['challenge-creator', 'challenge-participant'],
    key: 'challengeId',
    tenantPath: [],
    userPath: [],
  },
  'ChallengeUpdated.update': {
    roles: ['challenge-creator', 'challenge-participant'],
    key: 'challengeId',
    tenantPath: [],
    userPath: [],
  },
  'ChallengeDeleted.delete': { roles: ['challenge-creator'], key: 'challengeId', tenantPath: [], userPath: [] },
};

const ownerRoles: string[] = ['challenge-creator'];
const customerRoles: string[] = [];
const tenantRoles: string[] = ['challenge-creator', 'challenge-participant'];
